               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              ...
                              <a class="nav-item nav-link " href="viewRegisterPacsInspector">New</a>
                                <a class="nav-item nav-link active" href="viewRegisterPacsInspectorApprove">Approved</a>
                  	 ...
                  	 <form:form class="col-sm-12 form-horizontal customform" action="viewRegisterPacsInspectorApprove" autocomplete="off" modelAttribute="viewRegisterPacsInspectorApprove" method="post">
