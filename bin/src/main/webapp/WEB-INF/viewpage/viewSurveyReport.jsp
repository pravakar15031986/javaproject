...
<body>
					...
					<div class="card">
						<div class="card-header">
							<ul class="nav nav-tabs nav-fill" role="tablist">
								...
								<a class="nav-item nav-link active" href="viewSurveyReport">View</a>
							</ul>
						...
						<table class="table table-bordered viewTbl">
							<thead>
								<tr>
									...
									<th>Society Jurisdiction</th>
									<th> Reason For Survey</th>
									<th>Paddy Fields Category</th>
									<th>Total Plot Area(In Acre)</th>

									<th>Actual Area(In %)</th>

									<th>Nearby Fields</th>
									<th width="150px">Survey Date / Time</th>
							...
							<tbody>
								<c:forEach var="listValue" items="${surveyReportDataList}"
									...
									<tr>
										...
										<td>${listValue.villageName},
											${listValue.tahasilName},${listValue.distname}</td>
										...
										<td><a href="#" pid="${listValue.plot_code}"
											class="btn btn-sm btn-primary waves-effect waves-light viewDetails mr-0"><i
												class="fa fa-user"></i></a> <a data-placement="top"
											data-toggle="tooltip" data-title="View Map" href="#"
											class="btn btn-sm btn-warning waves-effect waves-light mr-0"><i
												class="fa fa-map-marker" aria-hidden="true"></i></a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
    ...
    <div class='accordianBtn'>
        <span class="acc_heading text-success">Survey Details</span><span><i class="fa fa-plus toogleIcon" aria-hidden="true"></i></span>
    </div>
    <div class='hideshowdiv'>
	   <div class="row">
                              ...
                              <div class="col-12 col-sm-6 col-md-4">
                               ...
                               <div class="col-12 col-sm-6 col-md-4">
                                 <div class="form-group">
                                    <label class="control-label">Supervisor Photo</label>
    ...
    <div class='accordianBtn'>
        <span class="acc_heading text-success">Data Captured Information</span><span><i class="fa fa-plus toogleIcon" aria-hidden="true"></i></span>
    </div>
    <div class='hideshowdiv'>
		       <div class="row">
                                       <div class="col-12 col-sm-6 col-md-4">
    ...
    <div class='accordianBtn'>
        <span class="acc_heading text-success">Status Information</span><span><i class="fa fa-plus toogleIcon" aria-hidden="true"></i></span>
    </div>
    <div class='hideshowdiv'>
    	 <div class="row">
