package com.csm.ORSAC.adminconsole.webportal.bean;

public class IPTrackBean {

	private Integer sNo;

	private String userId;

	private String iptrackId;

	private String status;

	public String getIptrackId() {
		return iptrackId;
	}

	public void setIptrackId(String iptrackId) {
